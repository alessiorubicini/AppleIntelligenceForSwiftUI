...
public struct SuggestionBubble: View {
...
#Preview {
    VStack(spacing: 30) {
        SuggestionBubble(suggestion: "Sure, let's meet at 3pm!", displayMode: .popover) {
            print("Suggestion tapped!")
        }
        SuggestionBubble(suggestion: "How can I help you today?", displayMode: .inline)
    }
    .padding()
